		...
		<form action="" method="POST">
			<div class="row">
				<div class="col-md-6">
					...
					<input type="text" class="form-control" name="name" placeholder="Nama Kawasan / Bangunan" value="<?= $sg->sg_name ?>" /><br />
					
					Keterangan:
					<textarea class="form-control" name="description" placeholder="Keterangan"><?= $sg->sg_description ?></textarea><br />
					
					Alamat:
					<textarea class="form-control" name="address" placeholder="Alamat"><?= $sg->sg_address ?></textarea><br />
				...
				<div class="col-md-6">
					...
					Nota:
					<textarea class="form-control" name="note" placeholder="Nota"><?= $sg->sg_note ?></textarea><br />
				</div>
