<div class="card">
    <div class="card-header">
        ...
        <a href="<?= PORTAL ?>permohonan/pindah_milik/add" class="btn btn-primary btn-sm float-right">
            Tambah Permohonan
        </a>
    </div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="<?= PORTAL ?>permohonan/pindah_milik/edit/<?= $t->tr_id ?>" class="btn btn-sm btn-warning">
                                Kemaskini
                            </a>
                            <a href="<?= PORTAL ?>permohonan/pindah_milik/view/<?= $t->tr_id ?>" class="btn btn-sm btn-success">
                                Lihat
                            </a>
                        </td>
                    </tr>
