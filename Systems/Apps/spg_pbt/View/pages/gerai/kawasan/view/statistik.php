...
<div class="mb-2 container-fluid bg-white shadow">
    <h3 class="flex-h1 pt-4 pr-4 pl-4">Gerai Berpenyewa / Masih Kosong</h3>
    <div class="row" style="height: 800px; width:100%;padding:20px;">
        ...
        <div class="col d-flex d-flex justify-content-start  flex-column align-items-center  " style="width: 100%;padding:30px;">
            <div class="">
                <canvas id="pie-stat" width="600" height="600"></canvas>
...
<div class="mb-2 container-fluid ">
    <div class="row">
        <div class="col card m-2 ">
            <div class="card-body ">
                <h3 class="flex-h1 pt-4 pr-4 pl-4">Senarai Gerai Yang Ada Tunggakan</h3>
...
<div class="mb-2 container-fluid ">
    <div class="row">
        <div class="col card m-2 ">
            <div class="card-body ">
                <h3 class="flex-h1 pt-4 pr-4 pl-4">Senarai Gerai Dalam Permohonan</h3>
