	...
	<table class="table table-fluid table-hover">
		<thead>
			<tr>
				...
				<th class="text-center">Alamat Gerai </th>
		...
		<tbody>
			<tr>
				...
				<td>
					04 - Tingkat 02 Blok 1, Jalan Pendidikan 3, Taman Universiti, 81300 Skudai, Johor
				</td>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row"> 
										<div class="col-md-12 form-group">
                                            Gerai:
                                            <select id="status-select" name="gerai" class="form-control">
												<option>Gerai</option>
											</select>
                                        </div>
										<div class="col-md-12 form-group">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
										<div class="col-md-12 form-group">
                                            Gerai:
                                            <select id="status-select" name="gerai" class="form-control">
												<option>04 - Tingkat 02 Blok 1, Jalan Pendidikan 3, Taman Universiti, 81300 Skudai, Johor</option>
											</select>
                                        </div>
										<div class="col-md-12 form-group">
											Gred
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
										<div class="col-md-12 form-group">
                                            Gerai:
                                            <select id="status-select" name="gerai" class="form-control" disabled>
												<option>04 - Tingkat 02 Blok 1, Jalan Pendidikan 3, Taman Universiti, 81300 Skudai, Johor</option>
											</select>
                                        </div>
