...
<div class="row container-fluid mt-3 mb-5 mapBlock">
    <div class="col-md-6 col-sm-6 col-12 ">
        <div class="row">
            <div class=" card col    d-flex flex-row justify-content-center  align-items-center" style="height: 200px; width:1000px;">
            ...
            <div class=" card col    d-flex flex-row justify-content-center  align-items-center" style="height: 200px; width:200px;">
                <div class="col-md-4 d-none d-md-block center-typcn mr-4 ">
                    <span class="iconify" data-icon="foundation:graph-pie" data-width="100" data-height="100"></span>
                </div>
                <div class=" ">
            ...
            <div class="w-100 "></div>
            <div class="card container-fluid" style=" height: 240px;">
    ...
    <div class="card col-12 col-md-6 col-sm-6 col-6 d-flex flex-row justify-content-center  align-items-center container-fluid">
        <div class="row pl-3">
            <canvas id="lol3" width="700" height="500"></canvas>
        </div>
...
<div class="row container-fluid mt-3 mb-5 mapBlock">
    ...
    <div class="card col-md-9 col-sm-9 col-9  " style="height: 900px;">
        <div class="card-body text-center">
            <h3 class="flex-h1 pt-4 pr-4 pl-4">Nama Senarai Yang Akan Di Senarai Hitam</h3>
...
<script>
    var ctxxd = document.getElementById("lol3").getContext('2d');
