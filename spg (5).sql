...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2022 at 02:10 PM
...
CREATE TABLE `cleanliness` (
  ...
  `cl_shop` int(11) NOT NULL,
  `cl_status` varchar(255) NOT NULL,
  `cl_description` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `cleanliness` (`cl_id`, `cl_date`, `cl_shop`, `cl_status`, `cl_description`) VALUES
(1, '2022-08-09', 5, 'Baik', 'Cemerlang'),
(2, '2022-08-10', 5, 'Memuaskan', 'Perlu diperbaiki');
...
CREATE TABLE `complaint` (
  ...
  `cp_complaint` varchar(255) NOT NULL,
  `cp_user` int(11) NOT NULL,
  `cp_sg` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `complaint` (`cp_id`, `cp_date`, `cp_complaint`, `cp_user`, `cp_sg`) VALUES
(1, '2022-08-03', 'asdasfersf', 1, 32),
(2, '2022-08-10', 'try try try try', 1, 32),
(3, '2022-08-10', 'gddgndc', 1, 33);
...
INSERT INTO `contracts` (`c_id`, `c_shop`, `c_tenant`, `c_pic`, `c_council`, `c_period`, `c_price`, `c_deposit`, `c_shopType`, `c_status`, `c_key`, `c_refer`, `c_fail`, `c_main`, `c_after`, `c_updateBy`, `c_dateStart`, `c_dateEnd`) VALUES
(1, 5, 1, 6, 6, 4, 30000, 5000, 1, 0, 'CONTRACT_61e462d13b63f', 'C12345', 'Fail 1', 1, 0, 0, '2022-07-02', '2023-07-01'),
(2, 5, 1, 1, 6, 0, 30000, 5000, 1, 0, 'CONTRACT_62d973a925807', 'C12345T', 'Fail 1', 2, 0, 1, '2022-07-02', '2023-07-01'),
(3, 5, 1, 1, 6, 0, 30000, 5000, 1, 0, 'CONTRACT_62d977f6da2f5', 'C12345T', 'Fail 1', 2, 3, 1, '2022-07-02', '2023-07-01');
...
(1, 1, 0, 1, '2022-07-19', 1658253504, 'Permohonan baru'),
(2, 2, 1, 1, '2022-07-21', 1658446889, 'Permohonan Lulus'),
(3, 1, 0, 1, '2022-07-21', 1658447935, 'disemak'),
(4, 3, 0, 1, '2022-07-21', 1658447990, 'Permohonan Baru'),
(5, 3, 0, 1, '2022-07-21', 1658448234, 'Disemak'),
(6, 3, 3, 1, '2022-07-21', 1658448250, 'gagal');
...
(6, 0, 4, 'Sewaan', 'sewaan', 'sewaan', 1, 'Maklumat Sewaan Gerai Bulanan', '', 'typcn typcn-th-small-outline', '0,1,2,4'),
...
(13, 0, 3, 'Permohonan', 'permohonan', 'permohonan', 1, 'Bahagian Permohonan', 'PER', 'typcn typcn-th-large', '0,1,2,4'),
...
(16, 13, 3, 'Pindah Milik', 'pindah_milik', 'pindah_milik', 1, 'Permohonan Pindah Milik', 'MLK', 'typcn typcn-th-large', '0,1,2'),
...
(24, 0, 1, 'Dashboard', 'dashboard', 'dashboard', 1, 'Paparan Orang Awam', '', 'fa fa-building', '3,4'),
(25, 0, 1, 'Dokumen', 'dokumen', 'dokumen', 1, 'Senarai Dokumen', '', 'fa fa-building', '4'),
(26, 0, 1, 'Temu Duga', 'temuduga', 'temuduga', 1, 'Seanarai Temu DUga', '', 'fa fa-building', '3,4'),
(27, 0, 1, 'Laporan', 'laporan', 'laporan', 1, 'Senarai Laporan', '', 'fa fa-building', '3');
...
--
-- Dumping data for table `request_deposits`
--

INSERT INTO `request_deposits` (`rd_id`, `rd_contract`, `rd_tenant`, `rd_date`, `rd_time`, `rd_status`, `rd_updateBy`) VALUES
(1, 1, 1, '2022-07-19', 1658256529, 0, 1);
...
--
-- Dumping data for table `request_deposit_logs`
--

INSERT INTO `request_deposit_logs` (`rdl_id`, `rdl_request`, `rdl_user`, `rdl_status`, `rdl_message`, `rdl_time`, `rdl_date`) VALUES
(1, 1, 1, 0, 'Initial Request', 1658256529, '2022-07-19');
...
(10, '', '12', '1234ABC', '1234', '', '', '1', '2', 'Jalan A', 'Taman B', 'Kulai', 'Johor', 800000, '', '0000-00-00', 0, 2, '', '', 'SHOP_62f1d1827414c', 0, 30500, 'A', 34);
...
(11, 'testorangawam', 'oa@gmail.com', 'cda8206eb90ff0ff143e5ee404d980102b37b7de52774b414bca3cc69d2ef6e3', '', 'orangawamtest', '9393939393939', 'australia', 'nepal', '343434343434', 0, 4, 3, '34343', 'Bangladesh', 'sri lanka', 'ayam');
...
CREATE TABLE `utility` (
  ...
  `ut_acc` varchar(255) NOT NULL,
  `ut_water` double NOT NULL,
  `ut_electricity` double NOT NULL,
  `ut_other` varchar(255) NOT NULL,
  `ut_date` date NOT NULL,
  `ut_shop` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `utility` (`ut_id`, `ut_acc`, `ut_water`, `ut_electricity`, `ut_other`, `ut_date`, `ut_shop`) VALUES
(1, 'MY12425', 200, 259, '--', '2022-08-01', 5),
(2, 'MY12425', 4365, 4564, 'tiada', '2022-08-10', 5),
(3, 'MY12425A', 676, 487, '', '2022-08-10', 5);
...
--
ALTER TABLE `request_deposit_logs`
  MODIFY `rdl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
